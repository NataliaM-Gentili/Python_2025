...
#k = 3 reemplaza for in range(3)
#se "igualan" (posicionalmente hablando) las listas, 
# por lo que la pregunta 0 se corresponde con las respuestas en la posicion 0 y la opcion correcta de la posicion 0   
for pregunta, respuestas, correcta in questions_to_ask:
    ...
    for intento in range(2):
        ...
        elif (user_answer < 0) or (user_answer > (len(respuestas)-1)): 
...
print(f"Usted ha obtenido un total de ",puntaje," puntos") 
